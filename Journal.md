...
- Studied ultrasensitive electroscope designs and physics principles


 Why
I wanted to build a device capable of detecting extremely weak electric charges for advanced physics experiments and learning.
...
- Selected insulating materials to minimize charge loss
- Sketched the mechanical layout

Challenges
- Balancing mechanical stability with high sensitivity
...
- Making the list of other materials needed. 
...
* Resistors
* Ceramic Capacitor
* 2 9V batteries & battery holders
* LCD 16*2
* GS6002-SRNCP6002 Op Amp
* Step down 
...
- Making 3d Design of the isolation box, which is made from Aclyric sheets. 
- Searching more about types of probes to increase the accuracy of the device
- Making a mew probe in a double circular shape sandwitch, made from aluminum foil. 
Results:
- Noticeable increase in sensitivity
-  More stable readings
